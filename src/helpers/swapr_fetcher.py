"""
Swapr Fetcher - Fetch price data from Swapr/Algebra pools.

Provides a class-based interface for Swapr price fetching,
...
__all__ = ["SwaprFetcher"]


class SwaprFetcher:
    """Fetches price data from Swapr/Algebra pools."""
    
    def __init__(self, w3: Web3 | None = None, pool_address: str | None = None):
        """Initialize the Swapr fetcher.
    ...
    def get_price(
        ...
        """Get the spot price from a Swapr pool.
        
        Args:
            pool_address: Pool address. Uses default if not provided.
            base_token_index: Index of base token (0 or 1). Auto-detects if None.
